                ...
                <div>
                    ...
                    <div className="m-16 ">
                        ...
                        <div className="flex w-full justify-center gap-5">
                            <div className="bg-rouded  border rounded-full w-24 h-24 justify-center"><img className="border rounded-full w-24 h-24" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFvwAtdSHs8oQm5Mxtzqi0H87L0gAOC8FACASLl8K_yxoCsmb6c8-dxV87vcXzxPt_iMw&usqp=CAU" alt="" /></div>
