    ...
    return (
        <div className="w-full h-auto ">
            <div className="w-full  rounded-tl-md ">
                <div className="h-[66px] shadow-sm shadow-[#FFF1EB] shadow-opacity-[30%]  flex items-center justify-between bg-white  ">
            ...
            <div>
                <div className=" flex justify-between m-10 mt-5 text-left text-[#7e22ce] "><h1 className="text-4xl font-bold ">Edit Transcript</h1> {isTextaria ? (<div><button onClick={DiscardTextAria} className=" text-red-600 border border-red-600 font-bold  pt-2 rounded-lg w-40">Discard</button> <button onClick={saveAndExit} className="  text-white bg-[#7e22ce] font-bold  pt-2 rounded-lg w-40">Save & exit</button></div>) : null}</div>
